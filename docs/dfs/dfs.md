...
You can change the ownership of the entire `chfs` directory (including all subdirectories and files inside it) to `stu` **inside the container** using the `chown` command. Here is how you can do it:
