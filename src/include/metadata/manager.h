...
public:
  ...
  auto allocate_inode_with_log(InodeType type, block_id_t bid, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<inode_id_t>;
  ...
  auto get_from_memory(inode_id_t id, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<block_id_t>;
  ...
  auto free_inode_with_log(inode_id_t id, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsNullResult;
  ...
  auto get_type_from_memory(inode_id_t id, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<InodeType>;
  ...
  auto set_table_in_memory(inode_id_t idx, block_id_t bid, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsNullResult;    
...
private:
  ...
  auto read_inode_from_memory(inode_id_t id, std::vector<u8> &buffer, std::vector<std::shared_ptr<BlockOperation>> &ops)
  -> ChfsResult<block_id_t>;
};
