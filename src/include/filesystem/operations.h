...
public:
  ...
  auto alloc_inode_with_log(InodeType type, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<inode_id_t>;
  ...
  auto write_file_with_log(inode_id_t, const std::vector<u8> &content, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsNullResult;
  ...
  auto read_file_from_memory(inode_id_t, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<std::vector<u8>>;
  ...
  auto remove_file_with_log(inode_id_t, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsNullResult;
  ...
  auto lookup_from_memory(inode_id_t, const char *name, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<inode_id_t>;
  ...
  auto mk_helper_with_log(inode_id_t parent, const char *name, InodeType type, std::vector<std::shared_ptr<BlockOperation>> &ops)
      -> ChfsResult<inode_id_t>;
  ...
  auto mkdir_with_log(inode_id_t parent, const char *name, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<inode_id_t> {
    return mk_helper_with_log(parent, name, InodeType::Directory, ops);
  }
  ...
  auto mkfile_with_log(inode_id_t parent, const char *name, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsResult<inode_id_t> {
    return mk_helper_with_log(parent, name, InodeType::FILE, ops);
  }
  ...
  auto unlink_with_log(inode_id_t parent, const char *name, std::vector<std::shared_ptr<BlockOperation>> &ops) -> ChfsNullResult;
